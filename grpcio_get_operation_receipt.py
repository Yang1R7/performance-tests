...
open_debit_card_account: OpenDebitCardAccountResponse = accounts_gateway_service.OpenDebitCardAccount(
...
make_top_up_operation_request = MakeTopUpOperationRequest(
    status=2,
    account_id=open_debit_card_account.account.id,
    card_id=open_debit_card_account.account.cards[0].id,
    amount=fake.amount(),
)
