...
from clients.grpc.client import GRPCClient, build_gateway_locust_grpc_client
...
class CardsGatewayGRPCClient(GRPCClient):
    ...
    def issue_virtual_card(self, user_id: str, account_id: str) -> IssueVirtualCardResponse:
        """
        Выпуск новой виртуальной карты для указанного пользователя и счета.
    ...
    def issue_physical_card(self, user_id: str, account_id: str) -> IssuePhysicalCardResponse:
        """
        Выпуск новой физической карты для указанного пользователя и счета.
